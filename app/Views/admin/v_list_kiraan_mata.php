...
<form name="carian" action="<?= site_url()?>/admin/list_kiraan_mata" method="post">
    ...
    <div class="col-xs-12">
      ...
      <div class="box box-success">
        ...
        <!-- <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal-tambah">Tambah</button> -->
          ...
          <h3 class="box-title">Senarai Kiraan Mata</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
        <!-- <form action="<?php echo url_to('rayuan_baru.download'); ?>" method="POST">
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <th width="28%">No fail jim</th>
              <th width="20%">Status</th>
              <th width="20%">Status Perakuan</th>
            ...
            <tr>
              ...
              <?php if (!empty($row['id_rayuan'])) { ?>
                <input type="checkbox" name="senarai_id_surat_masuk[]" class="pilih_rayuan" value="<?php echo $row['id_rayuan']; ?>" id=""
              ...
              <!-- (!empty($row['cipta_pada'])) ? format_date($row['cipta_pada'],'d-m-Y') : "-" -->
              </td>
             </td>
              <td>
              <?= (!empty($row['status_perakuan'])) ? $row['status_perakuan'] : "-" ?> 
              <!-- <?php //echo get_status_rayuan($row['status_rayuan']); ?>   -->
              <!-- (!empty($row['cipta_pada'])) ? format_date($row['cipta_pada'],'d-m-Y') : "-" -->
              </td>
              <td>
...
<!-- 
                  ...
                  <?php }  ?>
					 ...
					 onclick="window.location.href='<?= site_url()?>/Admin/surat_rayuan_baru/<?= $row['id_surat_masuk']?>';"">
...
<div class="modal-dialog ">
    ...
    <!--  =============================copy here============================================== -->
        ...
        <div class="box-group" id="accordion">
         ...
         <select required id="umur" name="umur"class="form-control select2" style="width: 100%;">

             <option value="5" >-Sila Pilih-</option>
            ...
            <option value="3"<?php if($row['umur']=='3'){echo"selected"; }?> >Bawah 18 tahun</option>
                ...
                <div class="panel box box-success">
                  ...
                  <input type="text" class="col-sm-4 col-md-3" id="menetap_sebenar_<?= $row['id_surat_masuk']?>" 
                  name="tem_menetap_real" value="" readonly><label>tahun</label>
                  ...
                  <td>
                  <textarea class="form-control pull-right" rows="3" 
                  name ="cttn_tem_menetap" id="cttn_tem_menetap" value ="" style="width: 170px; height: 90px;"
                   placeholder="Catatan....."><?= $row['cttn_tem_menetap']?></textarea>
                ...
                <select name="tem_menetap" id="tem_menetap" class="form-control select2" style="width: 100%;">
                  ...
                  name="tem_kahwin_real" value="" readonly><label>tahun</label>
                </td>
                ...
                <option value="" >-Sila Pilih-</option>
                  <option value="2" >3 hingga 4 tahun warganegara</option>
                  <option value="1" >3 hingga 4 tahun PR</option>
                  <option value="5">5 hingga 9 tahun warganegara</option>
                  <option value="3" >5 hingga 9 tahun PR</option>
                  <option value="7" >10 hingga 14 tahun warganegara</option>
                  <option value="5" >10 hingga 14 tahun PR</option>
                  <option value="10" >15 tahun keatas warganegara</option>
                  <option value="7" >15 tahun keatas PR</option>
                ...
                <tr>
                  ...
                  Bilangan Isteri Warganegara<input type="number" class="form-control" name="hub_keluarga4" id="hub_keluarga4"
                  ...
                  <td>
                <!-- <label>Bilangan anak</label> -->
                Bilangan Isteri PR<input type="number" class="form-control" name="hub_keluarga5" id="hub_keluarga5"
                ...
                <tr>
                  ...
                  Bilangan adik beradik Warganegara <input type="number" class="form-control" name="hub_keluarga6" id="hub_keluarga6"
                  ...
                  <td>
                <!-- <label>Bilangan anak</label> -->
                Bilangan adik beradik PR <input type="number" class="form-control" name="hub_keluarga7" id="hub_keluarga7"
                ...
                <tr>
                  ...
                  Bilangan anak kandung warganegara<input type="number" class="form-control" name="hub_keluarga8" id="hub_keluarga8"
                  ...
                  <td>
                  Bilangan anak kandung PR<input type="number" class="form-control" name="hub_keluarga9" id="hub_keluarga9"
                ...
                <tr>
                  ...
                  name="tem_pengalaman_real" value="" readonly>

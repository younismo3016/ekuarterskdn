    ...
    <div class="modal-content">
      ...
      <?php echo form_open('Admin/edit_user/'.$row['id_user']);?>
        ...
        <div class="form-group">
          <label>Nama</label>
          <div >
            <input type="text" class="form-control" name="name_user" value="<?= $row['name_user']?>" placeholder="nama">
          </div>
        </div>
        <div class="form-group">
          <label>email</label>
          <div >
            <input type="text" class="form-control" name="email" value="<?= $row['email']?>" placeholder="emel">
          </div>
        </div>  
        <div class="form-group">
          <label>No HP</label>
        ...
        <div class="form-group">
          <label>Level</label>
          <div >
            <input type="text" class="form-control" name="level" value="<?= $row['level']?>" placeholder="Level">
          </div>
        </div> 
        <div class="form-group">
          <label>Password</label>

...
<style>
    ...
    .table-container {
        ...
        /* Scroll ke bawah */
        max-height: 75vh;
        /* Hadkan tinggi supaya header sticky nampak berfungsi */
...
<section class="content">
        ...
        <form action="<?= base_url('index.php/agensi/simpan_kemaskini') ?>" method="POST" id="formSimpan">
            ...
            <div class="pagetitle">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div class="mt-3 text-end pb-5 d-flex gap-2 justify-content-end">
                        <?php if (!empty($kuarters_tersedia)) : ?>
                            <button type="button" class="btn btn-info btn-sm text-white shadow-sm px-3 py-1" data-bs-toggle="modal" data-bs-target="#modalTambahKuarters">
                                <i class="bi bi-plus-circle me-2"></i> Tambah Kuarters ke Laporan
                            </button>
                        <?php endif; ?>

                        <button type="submit" class="btn btn-primary btn-sm shadow-sm px-3 py-1">
                            <i class="bi bi-floppy-fill me-2"></i> Simpan Draf
                        </button>

                        <button type="button" onclick="confirmHantarKDN()" class="btn btn-success btn-sm shadow-sm px-3 py-1">
            ...
            <div class="row mb-3 mt-4 align-items-center">
                <div class="col-md-8">
                    <div class="input-group shadow-sm">
                        ...
                        <select name="status_tally" form="formCarian" class="form-select" style="max-width: 180px;">
                            <option value="SEMUA" <?= ($status_tally == 'SEMUA') ? 'selected' : '' ?>>
                                🔍 SEMUA
                            </option>
                            <option value="TALLY" <?= ($status_tally == 'TALLY') ? 'selected' : '' ?>>
                                ✅ TRUE
                            </option>
                            <option value="TIDAK_TALLY" <?= ($status_tally == 'TIDAK_TALLY') ? 'selected' : '' ?>>
                                ❌ FALSE
                            </option>
                        </select>
    ...
    <div class="d-flex flex-column text-muted" style="line-height: 1.4;">
        <span style="font-size: 0.85rem;">
            ...
            <?= !empty($oleh) ? 'Kemaskini Terakhir:' : 'Dicipta pada:'; ?>
        ...
        <?php endif; ?>
            ...
            <?php if (!empty($kuarters_tersedia)) : ?>
                <div class="alert alert-warning d-flex align-items-center shadow-sm py-2 px-3" role="alert" style="font-size: 0.9rem;">
                    <i class="bi bi-exclamation-triangle-fill me-2" style="font-size: 1.1rem;"></i>
                    <div>
                        Terdapat <strong><?= count($kuarters_tersedia); ?></strong> kuarters baru yang belum dimasukkan ke dalam laporan ini, klik Tambah Kuarters Ke Laporan untuk semak.
                    </div>
                </div>
            <?php endif; ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea
                                        ...
                                        onmouseleave="this.style.height = '31px';"><?= $row['ket_baik_guna_sama'] ?></textarea>
                                </td>
                                ...
                                <td>
                                    <textarea
                                        ...
                                        onmouseenter="this.style.height = 'auto'; this.style.height = this.scrollHeight + 'px';"
                                        onmouseleave="this.style.height = '31px';"><?= $row['ket_baik_tukar_fungsi'] ?></textarea>
                                </td>
                                ...
                                <td>
                                    <textarea
                                        ...
                                        onblur="this.style.height = '31px';"><?= $row['ket_baik_sewaan'] ?></textarea>
                                </td>
                                ...
                                <td>
                                    <textarea
                                        ...
                                        onmouseenter="this.style.height = 'auto'; this.style.height = this.scrollHeight + 'px';"
                                        onmouseleave="if(document.activeElement !== this) { this.style.height = '31px'; }"
                                        onblur="this.style.height = '31px';"><?= $row['ket_rosak_baik_pulih'] ?></textarea>
                                </td>
                                ...
                                <td>
                                    <textarea
                                        ...
                                        onmouseenter="this.style.height = 'auto'; this.style.height = this.scrollHeight + 'px';"
                                        onmouseleave="if(document.activeElement !== this) { this.style.height = '31px'; }"
                                        onblur="this.style.height = '31px';"><?= $row['ket_rosak_guna_sama'] ?></textarea>
                                </td>
                                ...
                                <td>
                                    <textarea
                                        ...
                                        onmouseenter="this.style.height = 'auto'; this.style.height = this.scrollHeight + 'px';"
                                        onmouseleave="if(document.activeElement !== this) { this.style.height = '31px'; }"
                                        onblur="this.style.height = '31px';"><?= $row['ket_rosak_tukar_fungsi'] ?></textarea>
                                </td>
                                ...
                                <td>
                                    <textarea
                                        ...
                                        onmouseenter="this.style.height = 'auto'; this.style.height = this.scrollHeight + 'px';"
                                        onmouseleave="if(document.activeElement !== this) { this.style.height = '31px'; }"
                                        onblur="this.style.height = '31px';"><?= $row['ket_rosak_sewaan'] ?></textarea>
                                </td>
                                ...
                                <td>
                                    <textarea
                                        ...
                                        onmouseenter="this.style.height = 'auto'; this.style.height = this.scrollHeight + 'px';"
                                        onmouseleave="if(document.activeElement !== this) { this.style.height = '31px'; }"
                                        onblur="this.style.height = '31px';"><?= $row['ket_rosak_roboh'] ?></textarea>
                                </td>
                                ...
                                <td>
                                    <textarea
                                        ...
                                        onmouseenter="this.style.height = 'auto'; this.style.height = this.scrollHeight + 'px';"
                                        onmouseleave="if(document.activeElement !== this) { this.style.height = '31px'; }"
                                        onblur="this.style.height = '31px';"><?= $row['keterangan_isu'] ?></textarea>
                                </td>
                                ...
                                <td class="wide-input">
                                    <textarea
                                        ...
                                        onmouseenter="this.style.height = 'auto'; this.style.height = this.scrollHeight + 'px';"
                                        onmouseleave="if(document.activeElement !== this) { this.style.height = '31px'; }"
                                        onblur="this.style.height = '31px';"><?= $row['status_tindakan'] ?></textarea>
                                </td>
                                <td>
                                    <textarea
                                        ...
                                        onmouseenter="this.style.height = 'auto'; this.style.height = this.scrollHeight + 'px';"
                                        onmouseleave="if(document.activeElement !== this) { this.style.height = '31px'; }"
                                        onblur="this.style.height = '31px';"><?= $row['senarai_kerja'] ?></textarea>
                                </td>
                                ...
                                <td>
                                    <textarea
                                        ...
                                        onmouseenter="this.style.height = 'auto'; this.style.height = this.scrollHeight + 'px';"
                                        onmouseleave="if(document.activeElement !== this) { this.style.height = '31px'; }"
                                        onblur="this.style.height = '31px';"><?= $row['catatan'] ?></textarea>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination pagination-sm mb-0">
                        ...
                        <li class="page-item <?= ($page <= 1) ? 'disabled' : '' ?>">
                            <a class="page-link" href="<?= base_url('index.php/agensi/agensi_statistik_kemaskini/' . $bulan . '/' . $tahun . '?page=' . ($page - 1) . '&q=' . $keyword . '&status_tally=' . $status_tally) ?>">
                                Sebelum
                            </a>
                        </li>
                        ...
                        for ($i = $start_loop; $i <= $end_loop; $i++): ?>
                            <li class="page-item <?= ($page == $i) ? 'active' : '' ?>">
                                <a class="page-link" href="<?= base_url('index.php/agensi/agensi_statistik_kemaskini/' . $bulan . '/' . $tahun . '?page=' . $i . '&q=' . $keyword . '&status_tally=' . $status_tally) ?>">
                                    <?= $i ?>
                                </a>
                            </li>
                        <?php endfor; ?>
...
<form action="<?= base_url('index.php/agensi/simpan_kuarters_baru') ?>" method="post">
    <input type="hidden" name="bulan" value="<?= $bulan ?>">
    <input type="hidden" name="tahun" value="<?= $tahun ?>">
            ...
            <div class="modal-content border-0 shadow">
                <div class="modal-header bg-light">
                    <h5 class="modal-title fw-bold text-primary">
                        <i class="bi bi-building-add me-2"></i>Tambah Kuarters ke Laporan
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>

              <div class="modal-body">
    <p class="text-muted mb-3">Sila tandakan kuarters yang ingin dimasukkan dalam laporan untuk bulan <strong><?= $nama_bulan ?> <?= $tahun ?></strong>.</p>
        ...
        <table class="table table-bordered table-striped table-hover align-middle">
            <thead class="table-light">
                <tr>
                    ...
                    <th style="width: 20%;">Kod Kuarters</th>
                    <th>Nama Kuarters</th>
                </tr>
            </thead>
            <tbody>
                <?php if (!empty($kuarters_tersedia)) : ?>
                    <?php foreach ($kuarters_tersedia as $row) : ?>
                        <tr>
                            <td class="text-center">
                                <input type="checkbox" name="kuarters_baru[]" class="checkbox-item form-check-input" value="<?= $row['id_kuarters'] ?>">
                            </td>
                            <td><?= $row['kod_kuarters'] ?></td>
                ...
                <?php else : ?>
                    <tr>
                        <td colspan="3" class="text-center py-4 text-muted">
                            ...
                            Semua kuarters telah dimasukkan dalam laporan ini.
                        </td>
                    </tr>
                <?php endif; ?>
            </tbody>
    ...
    <?php if (!empty($kuarters_tersedia)) : ?>
        <div class="mt-2 text-muted" style="font-size: 0.85rem;">
            <i class="bi bi-info-circle me-1"></i> <em>Nota: Sila pilih sekurang-kurangnya satu kuarters.</em>
        </div>
    <?php endif; ?>
</div>
    ...
    <button type="submit" id="btnSubmitKuarters" class="btn btn-primary px-4" disabled>
        <i class="bi bi-check2-circle me-1"></i>Tambah Kuarters
    </button>
</div>
            </div>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const submitBtn = document.getElementById('btnSubmitKuarters'); // ID butang anda

        // Fungsi untuk hidup/matikan butang
        function toggleButton() {
            const anyChecked = document.querySelectorAll('.checkbox-item:checked').length > 0;
            submitBtn.disabled = !anyChecked;
        }

        // Fungsi apabila 'checkAll' ditukar
        if (checkAll) {
            checkAll.addEventListener('change', function() {
                checkboxes.forEach(checkbox => {
                    checkbox.checked = checkAll.checked;
                });
                toggleButton(); // Check butang selepas select all
            });
        }

        // Fungsi apabila salah satu checkbox item ditukar
        checkboxes.forEach(checkbox => {
            checkbox.addEventListener('change', function() {
                ...
                toggleButton(); // Check butang selepas individu select
            });
        });
    });
</script>
...
<script>
    // Tambah ini di bahagian bawah view anda
    document.querySelector('select[name="status_tally"]').addEventListener('change', function() {
        this.form.submit();
    });
</script>
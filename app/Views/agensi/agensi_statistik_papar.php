            ...
            <table class="table table-bordered align-middle small mb-0" id="mainTable">
                <thead class="text-center align-middle">
                    ...
                    <tr class="table-light text-dark" style="font-size: 0.7rem;">
                        <th style="background-color: #dae8fc;">Check</th>
                        <th style="background-color: #dae8fc;">Valid</th>
                        <th style="background-color: #c1f0fb;">Check</th>
                        <th style="background-color: #c1f0fb;">Valid</th>
                        <th style="background-color: #d1f7e4;">Jum</th>
                        <th style="background-color: #d1f7e4;">Ket</th>
                        <th style="background-color: #d1f7e4;">Jum</th>
                        <th style="background-color: #d1f7e4;">Ket</th>
                        <th style="background-color: #d1f7e4;">Jum</th>
                        <th style="background-color: #d1f7e4;">Ket</th>
                        <th style="background-color: #fbd5dd;">Jum</th>
                        <th style="background-color: #fbd5dd;">Ket</th>
                        <th style="background-color: #fbd5dd;">Jum</th>
                        <th style="background-color: #fbd5dd;">Ket</th>
                        <th style="background-color: #fbd5dd;">Jum</th>
                        <th style="background-color: #fbd5dd;">Ket</th>
                ...
                <tbody>
                    <?php if (!empty($reports)): foreach ($reports as $row): ?>
                        ...
                        <tr>
                            <td colspan="40" class="text-center py-4">Tiada data dijumpai.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>

...
<form name="carian" action="<?= site_url()?>/admin/laporan/individu" method="post">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                  <label for="exampleInputEmail1">No fail JIM</label>
                ...
                <div class="btn-group">
                  ...
                  <?php if($row['id_add']=='2'){ ?>
                    ...
                    <!-- <button type="button" class="btn btn-success btn-sm" data-toggle="modal" 
                          ...
                          onclick="window.location.href='<?= site_url()?>/admin/laporan/papar_laporan/<?= $row['id_surat_masuk']?>';">
    ...
    <?php }  ?>
         ...
         <table class="table table-bordered">
              ...
              value="" id="jim_cantum" name="jim_cantum">
                ...
                <tr>
                  ...
                  <td>Jenis PAS </td>
                  <td>
                  <select id="id_jenis_pas" name="id_jenis_pas" class="form-control select2" style="width: 100%;">
                  <option value="" >-Sila Pilih-</option>
        ...
        <div class="box-group" id="accordion">
         ...
         <select id="umur" name="umur"class="form-control select2" style="width: 100%;">
            ...
            <option value="10"<?php if($row['umur']=='10'){echo"selected"; }?> >Bawah 18 tahun</option>
                    <option value="5"<?php if($row['umur']=='5'){echo"selected"; }?>>Lebih 18 Tahun Kurang 25 tahun </option>
            </optgroup>
                ...
                <div class="panel box box-success">
                  ...
                  name="tem_menetap_real" value="" readonly>
                ...
                <select name="tem_menetap" id="tem_menetap" class="form-control select2" style="width: 100%;">
                  ...
                  name="tem_kahwin_real" value="" readonly> 
                </td>
